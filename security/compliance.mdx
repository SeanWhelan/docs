---
title: "Compliance"
description: "Estuary is compliant with many data regulations and industry standards and undergoes regular audits to track how we're doing. This document explores a few of the major standards in the regulatory landscape. Compliance reports are available on request."
---

### SOC[​](#soc "Direct link to SOC")
...
Let us know if you're interested in using Estuary for a [healthcare use case](https://estuary.dev/solutions/industry/healthcare-data-integration/). Handling Protected Health Information (PHI) with Estuary requires:
...
### CCPA & CPRA[​](#ccpa--cpra "Direct link to CCPA & CPRA")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/security/compliance.md)
