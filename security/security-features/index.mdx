...
description: "Estuary provides a number of security features to protect your data. This document covers some of the broadest capabilities built into the Estuary platform."
---
...
### Data encryption in motion and at rest[​](#data-encryption-in-motion-and-at-rest "Direct link to Data encryption in motion and at rest")
...
### Immutable infrastructure[​](#immutable-infrastructure "Direct link to Immutable infrastructure")

Systems are rebuilt with every new update to ensure they remain secure and up-to-date.

### Zero-trust network model[​](#zero-trust-network-model "Direct link to Zero-trust network model")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/security/security-features.md)
