---
title: "Log into Estuary Using SSO"
description: "You can register or log into the  with one of several methods. Sign in with either:"
---
...
## Initial SSO Setup[​](#initial-sso-setup "Direct link to Initial SSO Setup")
...
## Add SSO Users to Your Tenant[​](#add-sso-users-to-your-tenant "Direct link to Add SSO Users to Your Tenant")
...
2. Under [Account Access](/concepts/web-app/#account-access), in the **Organization Membership** section, click the **Add Users** button.
...
## Estuary SSO Details[​](#estuary-sso-details "Direct link to Estuary SSO Details")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/getting-started/sso-setup.md)
