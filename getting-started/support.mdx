---
title: "Support"
description: "There are multiple ways to receive support if you run into issues or have questions while working with Estuary."
---

<Check>
  Be aware of downtime affecting Estuary components by subscribing to [status
  updates](https://status.estuary.dev/).
</Check>
