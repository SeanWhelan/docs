...
description: "A step-by-step guide to setting up Change Data Capture (CDC) from MongoDB with Estuary."
---

![High level architecture](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image4_5c651b17d6/image4_5c651b17d6.png)
...
## Understanding Change Events in MongoDB[]()[​](#understanding-change-events-in-mongodb "Direct link to understanding-change-events-in-mongodb")
...
![Create event](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image5_b1229ced25/image5_b1229ced25.png)

- Update Events: Fired upon modifications to existing documents, including field updates and replacements.

![Update event](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image6_e1604c59d7/image6_e1604c59d7.png)

- Delete Events: Signaled when documents are removed from a collection.

<Note>
  In MongoDB, if you delete a key from a document, the corresponding change
  event that gets fired is an "update" event. This may seem counterintuitive at
  first, but in MongoDB, updates are atomic operations that can modify specific
  fields within a document, including removing keys. So, when a key is deleted
  from a document, MongoDB interprets it as an update operation where the
  specific field (i.e., the key) is being removed, resulting in an "update"
  event being generated in the oplog.
</Note>

![Delete event](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image3_5dc8c9ea52/image3_5dc8c9ea52.png)

## Introduction to Estuary[]()[​](#introduction-to-estuary-flow "Direct link to introduction-to-estuary-flow")
...
## Setting up MongoDB[]()[​](#setting-up-mongodb "Direct link to setting-up-mongodb")
...
### Read Access[]()[​](#read-access "Direct link to read-access")
...
![MongoDB built-in roles](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image15_627fe98d52/image15_627fe98d52.png)
...
### Configuration Considerations[]()[​](#configuration-considerations "Direct link to configuration-considerations")
...
### Configure MongoDB[]()[​](#configure-mongodb "Direct link to configure-mongodb")
...
![MongoDB deployment options](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image12_664e3a1404/image12_664e3a1404.png)
...
![Allowlisting Estuary's IP](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image13_3294633b1f/image13_3294633b1f.png)
...
<Note>
  You’re not going to set up `mongosh` for this tutorial, but this is the
  easiest way to get ahold of the connection string we’ll be using.
</Note>

![Grab your MongoDB connection string](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image9_81fdbf1a20/image9_81fdbf1a20.png)

Copy the connection string and head over to your [Estuary dashboard](https://dashboard.estuary.dev/) to continue the tutorial.

## Setting up Estuary[]()[​](#setting-up-estuary-flow "Direct link to setting-up-estuary-flow")
...
![Create a Source Capture](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image7_4cd384d7bd/image7_4cd384d7bd.png)
...
### MongoDB Capture Configuration[]()[​](#mongodb-capture-configuration "Direct link to mongodb-capture-configuration")

As a first step, in the Capture Details section, name your capture and optionally add a description for it.

![Capture details configuration](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image14_17211852c9/image14_17211852c9.png)
...
![Capture endpoint configuration](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image17_80203a1a77/image17_80203a1a77.png)
...
![Capture output collections confuration](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image18_77d0afe861/image18_77d0afe861.png)

### Documents and Collections[]()[​](#documents-and-collections "Direct link to documents-and-collections")
...
<Note>
  Keep in mind, these are not the same documents and collections as the ones in
  MongoDB, only the names are similar, but we are talking about separate
  systems.
</Note>
...
![Capture bindings configuration](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image16_aa92057159/image16_aa92057159.png)
...
### Automating schema evolution[]()[​](#automating-schema-evolution "Direct link to automating-schema-evolution")
...
### Publishing the Capture[]()[​](#publishing-the-capture "Direct link to publishing-the-capture")
...
![Successful capture publish screen](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image2_b4e6afde4d/image2_b4e6afde4d.png)
...
<Check>
  To ensure reliable data capture, it is recommended to [adjust the oplog
  size](https://www.mongodb.com/docs/manual/tutorial/change-oplog-size/#c.-change-the-oplog-size-of-the-replica-set-member)
  ...
  A recommended minimum retention period of at least 24 hours is sufficient for
  most cases.
</Check>

## Real-time CDC[]()[​](#real-time-cdc "Direct link to real-time-cdc")

Let’s head over to the collections page to see our arriving documents.

![Collections](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image8_515f331796/image8_515f331796.png)
...
![Collection details](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image10_77731295df/image10_77731295df.png)
...
![Insert new document](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image1_0a5fb197d3/image1_0a5fb197d3.png)
...
![CDC event verification](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image11_772715227c/image11_772715227c.png)
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/getting-started/tutorials/real-time-cdc-with-mongodb.md)
