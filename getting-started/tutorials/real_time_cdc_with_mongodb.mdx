...
description: "A step-by-step guide to setting up Change Data Capture (CDC) from MongoDB with Estuary Flow."
---
...
## Introduction to Estuary Flow[]()[​](#introduction-to-estuary-flow "Direct link to introduction-to-estuary-flow")
...
![Allowlisting Estuary Flow's IP](/images/getting-started/tutorials/real_time_cdc_with_mongodb/estuary-marketing-strapi-uploads/uploads/image13_3294633b1f/image13_3294633b1f.png)
...
## Setting up Estuary Flow[]()[​](#setting-up-estuary-flow "Direct link to setting-up-estuary-flow")
