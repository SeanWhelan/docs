...
description: "In this tutorial, you'll create your first complete  with Estuary using publicly available data."
---
...
#### Estuary[​](#estuary-flow "Direct link to Estuary")
...
10. Return to the Snowflake console and expand ESTUARY_DB and ESTUARY_SCHEMA. You'll find the materialized table there.
