---
title: "Quickstart for Flow"
description: "In this tutorial, you will learn how to set up a streaming Change Data Capture (CDC) pipeline from PostgreSQL to Snowflake using Estuary Flow."
---
...
For production use cases, you should [configure your own cloud storage bucket to use with Flow](/getting-started/installation/).

## Step 1. Set up a Capture[]()[​](#step-1-set-up-a-capture "Direct link to step-1-set-up-a-capture")

Head over to your Flow dashboard (if you haven’t registered yet, you can do so [here](https://dashboard.estuary.dev/register).) and create a new **Capture.** A capture is how Flow ingests data from an external source.

Go to the sources page by clicking on the **Sources** on the left hand side of your screen, then click on **+ New Capture**

![Add new Capture](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/new_capture_4583a8a120/new_capture_4583a8a120.png)

Configure the connection to the database and press **Next.**

![Configure Capture](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/capture_configuration_89e2133f83/capture_configuration_89e2133f83.png)
...
![Configure Collections](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/collections_configuration_34e53025c7/collections_configuration_34e53025c7.png)

## Step 2. Set up a Materialization[]()[​](#step-2-set-up-a-materialization "Direct link to step-2-set-up-a-materialization")
...
Head over to the **Destinations** page, where you can [create a new Materialization](https://dashboard.estuary.dev/materializations/create).

![Add new Materialization](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/new_materialization_31df04d81f/new_materialization_31df04d81f.png)
...
![Configure Materialization endpoint](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/materialization_endpoint_configuration_0d540a12b5/materialization_endpoint_configuration_0d540a12b5.png)
...
![Grab your Snowflake account id](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/snowflake_account_id_af1cc78df8/snowflake_account_id_af1cc78df8.png)
...
![Link Capture](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/link_source_to_capture_b0d37a738f/link_source_to_capture_b0d37a738f.png)
...
![Successful Deployment screen](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/publish_successful_4e18642288/publish_successful_4e18642288.png)

And that’s it, you’ve successfully published a real-time CDC pipeline. Let’s check out Snowflake to see how the data looks.

![Results in Snowflake](/images/getting-started/quickstart/estuary-marketing-strapi-uploads/uploads/snowflake_verification_2eb047efec/snowflake_verification_2eb047efec.png)
...
You’ll find instructions on how to use other connectors [here](/reference/Connectors/). There are more tutorials [here](/getting-started/tutorials/).

Also, don’t forget to join the [Estuary Slack Community](https://estuary-dev.slack.com/ssb/redirect#/shared-invite/email)!

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/getting-started/quickstart.md)
