---
title: "Asana"
description: "This connector captures data from ."
---
...
### Streams Available for Enterprise+ Organizations[​](#streams-available-for-enterprise-organizations "Direct link to Streams Available for Enterprise+ Organizations")
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the Asana source connector.
...
```
captures:  ${PREFIX}/${CAPTURE_NAME}:    endpoint:      connector:        image: ghcr.io/estuary/source-asana:dev        config:          credentials:            option_title: PAT Credentials            personal_access_token: <secret>    bindings:      - resource:          stream: attachments          syncMode: full_refresh        target: ${PREFIX}/attachments      {...}
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/asana.md)
