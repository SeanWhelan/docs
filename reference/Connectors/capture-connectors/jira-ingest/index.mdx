---
title: "Jira HTTP Ingest (Webhook)"
description: "The Jira HTTP Ingest connector allows you to capture data from  HTTP requests from Jira. A common use case is to capture webhook deliveries, turning them into a Flow collection."
---
...
### Configure a Jira webhook[​](#configure-a-jira-webhook "Direct link to Configure a Jira webhook")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/jira-ingest.md)
