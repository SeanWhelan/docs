...
<Info>
  ...
  Universal Analytics is supported by a [separate connector](/reference/Connectors/capture-connectors/google-analytics/).
</Info>
...
You configure connectors either in the Flow web app, or by directly editing a specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the Google Analytics 4 source connector.
...
[Segments](https://support.google.com/analytics/answer/9304353#zippy=%2Cin-this-article) and [filters](https://developers.google.com/analytics/devguides/reporting/data/v1/rest/v1beta/FilterExpression#Filter) are also supported. When using segments, you must include the `ga:segment` dimension:
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/google-analytics-4.md)
