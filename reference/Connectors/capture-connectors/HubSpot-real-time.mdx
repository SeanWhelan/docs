---
title: "HubSpot ( Real-Time )"
description: "This connector captures data from HubSpot into Flow collections."
---
...
## Supported HubSpot Resources[​](#supported-hubspot-resources "Direct link to Supported HubSpot Resources")
...
### Permissions and OAuth scopes[​](#permissions-and-oauth-scopes "Direct link to Permissions and OAuth scopes")
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the HubSpot Real-Time connector.
...
```
captures:  ${PREFIX}/${CAPTURE_NAME}:    endpoint:      connector:        image: ghcr.io/estuary/source-hubspot-native:dev        config:          client_id: <secret>          client_secret: <secret>          credentials_title: OAuth Credentials          refresh_token: <secret>    bindings:      - resource:          name: companies        target: ${PREFIX}/${COLLECTION_NAME}
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/HubSpot-real-time.md)
