---
title: "Incident.io"
description: "This connector captures data from Incident.io into Flow collections."
---
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification files. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the Incident.io source connector.
...
```
captures:  ${PREFIX}/${CAPTURE_NAME}:    endpoint:      connector:        image: ghcr.io/estuary/source-incident-io:dev        config:          credentials:            access_token: <secret>            credentials_title: Private App Credentials    bindings:      - resource:          name: incidents        target: ${PREFIX}/incidents
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/incident-io.md)
