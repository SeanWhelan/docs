...
description: "This connector captures data from one LinkedIn Page into Flow collections via the ."
---
...
### Access Token Authentication[​](#access-token-authentication "Direct link to Access Token Authentication")
...
#### Create a LinkedIn OAuth App[​](#create-a-linkedin-oauth-app "Direct link to Create a LinkedIn OAuth App")
...
#### Create a Refresh Token[​](#create-a-refresh-token "Direct link to Create a Refresh Token")
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the LinkedIn Pages source connector.
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/linkedin-pages.md)
