...
1. Allow connections to the database from the Estuary Flow IP address.
   ...
   1. Create a new [firewall rule](https://learn.microsoft.com/en-us/azure/mariadb/howto-manage-firewall-portal) that grants access to the [Estuary Flow IP addresses](/reference/allow-ip-addresses/).
