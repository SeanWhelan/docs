...
<Warning>
  This connector is deprecated. It is recommended that you use the new native [Jira connector](/reference/Connectors/capture-connectors/jira-native/) instead.
</Warning>
...
### Experimental streams[​](#experimental-streams "Direct link to Experimental streams")
