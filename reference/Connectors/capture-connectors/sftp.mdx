---
title: "SFTP"
description: "This connector captures data from an SFTP server."
---
...
## Subdirectories and Symbolic Links[​](#subdirectories-and-symbolic-links "Direct link to Subdirectories and Symbolic Links")
...
## File Capturing Order[​](#file-capturing-order "Direct link to File Capturing Order")
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the SFTP source connector.
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/sftp.md)
