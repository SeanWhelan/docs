...
description: "This connector captures data from an Azure Blob Storage Account."
---
...
## Setup **a Microsoft Entra application**[​](#setup-a-microsoft-entra-application "Direct link to setup-a-microsoft-entra-application")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/azure-blob-storage.md)
