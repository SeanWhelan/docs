---
title: "Intercom HTTP Ingest (Webhook)"
description: "The Intercom HTTP Ingest connector allows you to capture data from  HTTP requests from Intercom. A common use case is to capture webhook deliveries, turning them into a Flow collection."
---
...
### Configure a Intercom webhook[​](#configure-a-intercom-webhook "Direct link to Configure a Intercom webhook")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/intercom-ingest.md)
