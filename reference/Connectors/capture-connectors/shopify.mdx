...
<Warning>
  Shopify is deprecating their REST API in favor of their GraphQL API. We recommend using our [Shopify GraphQL connector](/reference/Connectors/capture-connectors/shopify-native/) whenever possible.
</Warning>
...
### Default Streams[​](#default-streams "Direct link to Default Streams")
...
### Shopify Plus Streams[​](#shopify-plus-streams "Direct link to Shopify Plus Streams")
...
```
captures:  ${PREFIX}/${CAPTURE_NAME}:    endpoint:      connector:        image: ghcr.io/estuary/source-shopify:dev        config:          credentials:            auth_type: access_token            access_token: <secret>          store: <store ID>          is_plus_account: false          start_date: 2020-01-01    bindings:      - resource:          stream: transactions          syncMode: full_refresh        target: ${PREFIX}/transactions      {...}
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/shopify.md)
