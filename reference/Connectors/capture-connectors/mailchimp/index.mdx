---
title: "Mailchimp"
description: "This connector captures data from a Mailchimp account."
---
...
### Using OAuth2 to authenticate with Mailchimp in the Flow web app[​](#using-oauth2-to-authenticate-with-mailchimp-in-the-flow-web-app "Direct link to Using OAuth2 to authenticate with Mailchimp in the Flow web app")
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification file. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the Mailchimp source connector.
