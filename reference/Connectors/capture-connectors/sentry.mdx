---
title: "Sentry"
description: "This connector captures data from Sentry into Flow collections."
---
...
You configure connectors either in the Flow web app, or by directly editing the catalog specification files. See [connectors](/concepts/connectors/#using-connectors) to learn more about using connectors. The values and specification sample below provide configuration details specific to the Sentry source connector.
...
```
captures:  ${PREFIX}/${CAPTURE_NAME}:    endpoint:      connector:        image: ghcr.io/estuary/source-sentry:dev        config:          credentials:            credentials_title: Private App Credentials            access_token: <your auth token>          organization: <your organization>          start_date: "2025-08-14T00:00:00Z"          advanced:            window_size: P10D    bindings:      - resource:          name: Issues          interval: PT5M        target: ${PREFIX}/Issues
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/capture-connectors/sentry.md)
