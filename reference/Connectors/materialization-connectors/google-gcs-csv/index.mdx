---
title: "CSV Files in Google GCS"
description: "This connector materializes  of Flow collections into files in a GCS bucket per the CSV format described in . The CSV files are compressed using Gzip compression."
---
...
[`ghcr.io/estuary/materialize-gcs-csv:dev`](https://ghcr.io/estuary/materialize-gcs-csv:dev) provides the latest connector image. You can also follow the link in your browser to see past image versions.
...
```
materializations:  ${PREFIX}/${mat_name}:    endpoint:      connector:        image: "ghcr.io/estuary/materialize-gcs-csv:dev"        config:          bucket: bucket          credentialsJson: <credentialsJson>          uploadInterval: 5m    bindings:      - resource:          path: ${COLLECTION_NAME}        source: ${PREFIX}/${COLLECTION_NAME}
```
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/materialization-connectors/google-gcs-csv.md)
