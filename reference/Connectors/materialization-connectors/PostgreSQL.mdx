---
title: "PostgreSQL"
description: "This connector materializes Flow collections into tables in a PostgreSQL database."
---
...
- [Amazon RDS](/reference/Connectors/materialization-connectors/PostgreSQL/amazon-rds-postgres/)
- [Google Cloud SQL](/reference/Connectors/materialization-connectors/PostgreSQL/google-cloud-sql-postgres/)
- [Azure Database for PostgreSQL](#azure-database-for-postgresql)
- [Supabase](/reference/Connectors/materialization-connectors/PostgreSQL/supabase/)
...
```
materializations:  ${PREFIX}/${mat_name}:    endpoint:      connector:        image: ghcr.io/estuary/materialize-postgres:dev        config:          database: flow          address: localhost:5432          password: flow          user: flow    bindings:      - resource:          table: ${TABLE_NAME}        source: ${PREFIX}/${COLLECTION_NAME}
```
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/reference/Connectors/materialization-connectors/PostgreSQL/PostgreSQL.md)
