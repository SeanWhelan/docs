...
<Warning>
  This page is outdated. It does not reflect the current state of the Flow web
  application and the [authorization model](/reference/authentication/) used to
  share entities in Flow catalogs. Updates are coming soon.
</Warning>
