---
title: "Configuring Task Shards"
description: "For some catalog tasks, it's helpful to control the behavior of . You do this by adding the  configuration to the capture or materialization configuration."
---
...
```
materializations:  acmeCo/snowflake-materialization:    endpoint:      connector:        config:          account: acmeCo          database: acmeCo_db          password: secret          cloud_provider: aws          region: us-east-1          schema: acmeCo_flow_schema          user: snowflake_user          warehouse: acmeCo_warehouse        image: ghcr.io/estuary/materialize-snowflake:dev    bindings:    - resource:        table: anvils      source: acmeCo/anvils    shards:      logLevel: debug      minTxnDuration: 30s      maxTxnDuration: 4m
```

[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/features/configuring-task-shards.md)
