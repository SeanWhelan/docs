...
description: "Estuary is a unified data movement and transformation platform for the whole data team."
---
...
- Perform _change data capture_ from MySQL tables into PostgreSQL or a cloud analytics warehouse like Snowflake or Databricks
