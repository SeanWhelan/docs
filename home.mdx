---
title: "What is Estuary Flow?"
description: "Estuary Flow is a unified data movement and transformation platform for the whole data team."
---
...
* Perform *change data capture* from MySQL tables into PostgreSQL or a cloud analytics warehouse like Snowflake or Databricks
...
## Get started with Flow[​](#get-started-with-flow "Direct link to Get started with Flow")
...
* **[Quickstart](/getting-started/quickstart/)**: Take a look at the Quickstart to see how easy it is to set up a real-time data flow.

* **[User guides](/guides/)**: Get familiar with Flow concepts by reading these byte-sized user guides.

* **[Tutorials](/getting-started/tutorials/)**: Check out some of our step-by-step tutorials where we show you how to set up complete data flows.

* **[High level concepts](/concepts/)**: Start here to learn more about important Flow terms.

## Watch the videos[​](#watch-the-videos "Direct link to Watch the videos")
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/getting-started/getting-started.md)
