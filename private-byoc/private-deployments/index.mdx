...
description: "Private deployments are a way to run Estuary Flow's data infrastructure within a private environment while maintaining the simplicity of SaaS. This can be especially helpful for enhanced security and compliance. With a private deployment, you have:"
---
...
![Estuary Private Deployment Architecture](/images/private-byoc/private-deployments/assets/images/private-deployment-architecture-ab3692ac4541fe74f8360c58757d24d9.png)
...
Estuary Flow stores data in [your private account](/getting-started/installation/) with any deployment option. For a private deployment, your data additionally stays within your private network as it moves through your data pipeline.
...
## Using Connectors with Private Data Planes[​](#using-connectors-with-private-data-planes "Direct link to Using Connectors with Private Data Planes")
...
![Data plane dropdown showcasing private and public data planes](/images/private-byoc/private-deployments/static/72ea8f5587a3ef1a80bc39cfa4eb1637/6768f/private_data_planes_page_capture_empty_field_3453f4f36e.webp)
...
[Edit this page](https://github.com/estuary/flow/edit/master/site/docs/private-byoc/private-deployments.md)
